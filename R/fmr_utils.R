...
#'     standard format is generated by using the function dataTemplateASPM. 
#'     which generates an example datafile which can be used to demonstrate the
...
#' @examples
#' \dontrun{
#' dataTemplateASPM(filename="test.csv", title="A test of the functions")
